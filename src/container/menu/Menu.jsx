...
const Menu = () => {
  ...
  const handleWorkFilter = (item) => {
    ...
    setTimeout(() => {
      ...
      if (item === "All") {
        ...
        setFilterWork(menu.filter((work) => work.tags.includes(item)));
      }
    }, 500);
  };
  ...
  return (
    <div className="eventWrapper">
      <h2>
        Check all<span className="eventHighlight"> Delicacies </span> available
        in <span className="eventHighlight">Daystar Athi</span>.{" "}
      </h2>

      <div className="app__work-filter">
        {["Chilltons", "Cafetaria", "Food Palace", "All"].map((item, index) => (
          <div
            key={index}
